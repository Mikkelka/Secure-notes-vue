<template>
  <div class="fixed bottom-0 left-0 right-0 h-16 bg-gray-800/90 backdrop-blur border-t border-gray-700/50 z-50 md:hidden">
...
defineEmits(['foldersClick', 'addNoteClick', 'searchClick', 'settingsClick'])
</script>